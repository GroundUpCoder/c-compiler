...
const GROUPS = [
  ...
  { title: 'Audio (push model + device-less conversion/mixing)',
    re: /Audio/,
...
const ABSENT = [
  ...
  { label: 'Audio files: `SDL_LoadWAV` and SDL_mixer (`Mix_*`) do not exist — parse audio data yourself, then convert with SDL_CreateAudioStream, mix with SDL_MixAudio, and push PCM through SDL_PutAudioStreamData.',
    absent: ['SDL_LoadWAV', 'Mix_OpenAudio'],
    see: ['SDL_PutAudioStreamData', 'SDL_CreateAudioStream', 'SDL_MixAudio'] },
