#!/usr/bin/env node
// win32ports.js — the 0060 Win32 port compile-test harness (docs/WIN32.md).
//
...
function generateReport(manifest, results) {
  ...
  L.push('');
  L.push('Generated by `node tools/win32ports.js` (docs/archive/0060; design docs/WIN32.md).');
