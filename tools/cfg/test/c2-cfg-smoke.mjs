// Smoke test for the c2 (SSA) CFG view.
//
...
assert(probe.backendLabel === "c2 (SSA)", `backend label should be "c2 (SSA)", got "${probe.backendLabel}"`);
...
await browser.close();
console.log("c2 CFG smoke: PASSED");
