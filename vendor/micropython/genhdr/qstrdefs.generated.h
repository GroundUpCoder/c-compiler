...
// Operator dunder qstrs must stay within the first 256 ids:
// mp_binary_op_method_name / mp_unary_op_method_name are byte arrays.
...
// pool1 (QDEF1) must stay sorted by string bytes: qstr_find_strn
// binary-searches it (is_sorted). Keep new entries in order.
