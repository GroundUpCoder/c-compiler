# notepad — ReactOS Notepad (docs/archive/0060 Win32 port corpus)
...
Status: fully linked against the veneer since docs/archive/0048 (EDIT-around-a-file
...
docs/archive/0223), and the Save As encoding combo degrades to the current value
