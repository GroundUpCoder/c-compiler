 ...
 */
#define AUTOCONF_TIMESTAMP "2026-07-08 23:19:58 KST"
...
#undef CONFIG_TIME64
#define ENABLE_TIME64 0
#define IF_TIME64(...)
#define IF_NOT_TIME64(...) __VA_ARGS__
#undef CONFIG_PAM
#define ENABLE_PAM 0
#define IF_PAM(...)
...
#define CONFIG_BUSYBOX_EXEC_PATH "/bin/sh" /* WASM PORT */
...
/* WASM PORT: NOMMU=y — this platform has no fork, exactly like NOMMU
 * Linux; BB_MMU 0 selects hush's vfork+re-exec machinery, which the
 * port's journaling shim maps onto __spawn (port/vfork_spawn.c). */
...
#endif
#define IF_NOT_UNAME(...)
#define CONFIG_UNAME_OSNAME "wasm"
...
#define ENABLE_FEATURE_FIND_EXEC_OK 0
#define IF_FEATURE_FIND_EXEC_OK(...)
#define IF_NOT_FEATURE_FIND_EXEC_OK(...) __VA_ARGS__
...
#define ENABLE_GETFATTR 0
#define IF_GETFATTR(...)
#define IF_NOT_GETFATTR(...) __VA_ARGS__
#undef CONFIG_HDPARM
