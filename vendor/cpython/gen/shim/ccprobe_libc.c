 ...
 *
 * TWO CONSUMERS compile this file (docs/CPYTHON.md §4.3): compiler.js via
 ...
 *
 *   - compiler.js's libc grew all seven (docs/archive/0325 Group A et al.), which
 ...
 *     libc (docs/archive/0330).  The #544 re-vendor advanced that pin past the
