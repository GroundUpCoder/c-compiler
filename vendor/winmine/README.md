# winmine — ReactOS/Wine Minesweeper (docs/archive/0060 Win32 port corpus)
...
return stub handles, and PlaySound (real since docs/archive/0094) keeps
...
Status: fully linked against the veneer since docs/archive/0068 (the user32/
