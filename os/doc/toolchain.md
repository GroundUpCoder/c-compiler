...
## External Wasm producers

The image builder and process host do not install or inject a Small-specific
compiler or runtime. External producers must satisfy the documented process ABI
and provide bindings through the ordinary host extension mechanisms.
