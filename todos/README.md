...
1. `0001` kernel Phase 2 — signal delivery, EINTR, exit handshake
2. `0002` kernel Phase 3 — tty object + line discipline
3. `0003` kernel Phase 4 — pipes + job control
4. `0004` os/ reference page + C protoshell (pid 1)
5. `0005` shell port (busybox ash) — the Phase-1 acceptance test
6. `0006` threads + atomics
7. `0007` window manager / compositor — design doc first
8. `0008` networking — AF_UNIX first
