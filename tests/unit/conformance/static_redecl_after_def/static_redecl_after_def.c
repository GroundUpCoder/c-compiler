...
//      the `static def; extern decl;` shape (docs/archive/0219) but gated it on the
...
// EXPECT: 42
// FIXED by docs/archive/0321 — the `specs.storageClass !== STATIC` condition was
//      removed (it guarded nothing: the same repro fails on the tree from
//      BEFORE docs/archive/0219 added the block). Was a pinned xfail; the
...
//      definitions. It caused 168 of 173 link errors in the docs/archive/0313 probe.
