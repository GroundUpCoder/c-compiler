...
int main(void) {
  ...
  __anyref any_f = __ref_as_any(__ref_as_extern(f));
  __anyref any_b = __ref_as_any(__ref_as_extern(b));
  ...
  __anyref any_a = __ref_as_any(__ref_as_extern(arr));
