...
async function main() {
  ...
  for (const [name, files, expected] of [
    ...
    ['nested-member-offsets', ['struct S {char a; _Alignas(8) char b; _Alignas(16) char c;}; @interface A {struct S x;} @end @implementation A @end', 'struct S {_Alignas(8) char a; char b; _Alignas(16) char c;}; @interface A {struct S x;} @end int main(void){return 0;}'], /inconsistent Objective-C layout/],
