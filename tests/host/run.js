...
var tests = [
  ...
  ['test_sdl_loadwav_diff.js', []],    // #723: SDL_LoadWAV differential vs the pinned upstream SDL 3.4.0 oracle manifest — 92 fixtures (every codec, malformed shape, truncation, zero-data) byte-identical in spec/len/decoded sha256/exact error string; demand-link witnesses in EVERY mode (default/--no-fold/--no-undefined: unreferenced = TU never compiled + declaration withdrawn; variable-keyed firing/suppression; EInitList/address-taken/dead-static/dead-extern reference routes); red controls on the comparator
