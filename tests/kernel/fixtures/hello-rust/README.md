# hello-rust.wasm — the committed Rust fixture (docs/archive/0413)
...
The module satisfies the gucOS ABI contract (`docs/RUST.md` §2): it imports
...
docs/archive/0414 the crate reaches the host only through `gucos-sys`, and its
