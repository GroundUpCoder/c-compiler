...
echo ""
echo "Bootstrap loop is open. compiler.js runs inside our QuickJS,"
echo "which was built by our compiler — the third stage of self-host."
echo ""
echo "See:"
echo "  - vendor/quickjs/README.md  — vendor status + patches"
echo "  - demos/self-host/          — stage 4: end-to-end self-host demo"
