...
Design, 2026-07-08 (queued: `docs/archive/0040`; subsumes the old unnumbered
...
## In-item decisions (landed with docs/archive/0040, 2026-07-08)

The design above left five things to decide in-item; here is what landed:

1. **Blob version location**: a FILE inside the blob —
   `/usr/share/os-release` (`NAME=gucOS` + `PRETTY_NAME` since docs/archive/0114,
