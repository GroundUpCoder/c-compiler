...
`/bin/mgba` (docs/archive/0112, done) is mGBA 0.10.5's C core built GBA-only
...
Every **real** GBA ROM derails. Tracked as **docs/archive/0140** (deferred, P3).
...
See docs/archive/0140. Two convergent tracks:
