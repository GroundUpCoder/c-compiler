...
approval. Read together with `docs/KEYMAP.md` (the scheme substrate, 0149/
0150), `docs/META-ARROW-KEYBIND.md` (Meta+arrow line-nav vs tiling) and
`docs/EXPOSE-MISSION-CONTROL.md` (the overview feature that will be the first
