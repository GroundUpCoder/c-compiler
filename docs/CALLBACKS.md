...
GC references are not packed into the integer context argument. Reference
imports require no numeric function-table conversion. The C compiler's existing table-based APIs continue to
...
surfaces, and direct Wasm references under JSPI and sync execution.
