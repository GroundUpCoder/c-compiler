...
- **Design inputs**: `os/win32/software.c` (the app being redesigned),
  `docs/WIN32.md` (veneer conventions: fail-loud 0211, A/W, "one
  toolkit" comctl32 stance), `docs/archive/0131-ctlpanel-restyle.md` (the same
  shape of ask, deferred), `docs/archive/0130-default-programs-applet.md`
  (re-opened; a direct customer of the new control),
  `docs/archive/0106-fileman-navigator-v2.md` (the existing hand-rolled
  details view), `docs/OS.md` + `docs/TOOLKIT.md` (the agent-drivable
  pillar).
