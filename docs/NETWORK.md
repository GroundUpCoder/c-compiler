...
subset as an app-side library (`os/curl/`, docs/archive/0173) backed by the
kernel fetch RPC family (opcode space 0x06xx, docs/archive/0172; see
...
CLI did not fall out for free — it is `docs/archive/0182`, done 2026-07-23:
