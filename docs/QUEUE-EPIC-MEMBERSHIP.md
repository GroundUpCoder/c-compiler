...
EXCLUSIVITY ruling needs (`docs/PKGDEV-EPIC.md`, "Queue selection"). The
...
stream classification" invariant holds again. `docs/QUEUE-CLASSIFICATION.md`'s
