...
- **#109** 0302 — recurring liability sweep: find gap-describing comments that never entered docs/ — *repo/estate liability-sweep process*
...
- **#170** 0401 — FIFOs: mkfifo(3) and path-named rendezvous (docs/archive/0382 gap 9) — *kernel FIFOs*
...
- **#544** Re-vendor clang-simplified's libc pin (docs/archive/0330) — retires #539's #ifdef __clang__ guard and the -Dwcstol rename — *toolchain (clang-simplified libc pin re-vendor)*
