...
main(int argc, char **argv)
{
	...
	/* CHARSET INVESTIGATION: register the SAME http/https fetcher the real
	 * gucOS frontend uses (gucos/httpfetch.c over __http_open), so this
	 * headless binary exercises the real transport's header path. */
