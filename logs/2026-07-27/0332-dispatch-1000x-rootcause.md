...
**Residual, filed as `todos/0335`:** a function with more than 65520 blocks still
...
noted in `todos/0336`; it does not touch this comparison, and the rebuilt
...
## 5. What this did NOT fix — startup, and why (`todos/0336`)
...
flattening, or shrinking the local count), is `todos/0336`.
...
decision is retaken, and read `todos/0336` first.
