...
Tickets filed: **`todos/0329`** (ship it — blocked, see §4) and **`todos/0328`** (the sibling's
...
- The two libcs are **206 commits apart** (§3). Ten files differ. Only three symbols were
  ...
  "same libc lineage" is not "same libc bytes", and closing that is `todos/0328`.
...
acceptance legs I cannot responsibly re-run mid-round. `todos/0328`.
...
make. `todos/0329` carries the full plan for the moment the tree exists.
