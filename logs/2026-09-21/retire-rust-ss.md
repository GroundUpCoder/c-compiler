...
Follow-up, 2026-09-22: the user explicitly directed landing this cleanup on
main, overriding the branch-only decision above. Merged with current main,
retaining its newer native Node SDL3/WebGPU support and generic custom-import
module-cache tests. The previously recorded integration failures remain
documented; this merge is not a claim that those gates passed.
